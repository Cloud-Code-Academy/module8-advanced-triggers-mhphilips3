...
trigger AccountTrigger on Account (before insert, after insert) {
    ...
    if (Trigger.isBefore && Trigger.isInsert) {
        ...
        // When an account is inserted change the account type to 'Prospect' 
        // if there is no value in the type field.
        ...
        // When an account is inserted set the rating to 'Hot' if the Phone, Website, 
        // and Fax is not empty.
        AccountHelper.setRating(Trigger.new);        
    }
    
    if(Trigger.isAfter && Trigger.isInsert){

        // When an account is inserted create a contact related to 
        // the account with the following default values:
